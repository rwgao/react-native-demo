    ...
    return (
      <ScrollView style={styles.container}>
        <WingBlank>
          ...
          <View style={styles.item}>
            <View style={styles.label}>
              <Text style={styles.text}>消费类型：</Text>
            </View>
            <View style={styles.content}>
          ...
          <View style={styles.item}>
            <View style={styles.label}>
              <Text style={styles.text}>消费点券：</Text>
            </View>
            <View style={styles.content}>
          ...
          <View style={styles.item}>
            <View style={styles.label}>
              <Text style={styles.text}>关联比赛：</Text>
            </View>
            <View style={styles.content}>
              <Text style={styles.text}>{detail.matchid}</Text>
            </View>
          </View>
          <View style={styles.item}>
            <View style={styles.label}>
          ...
          <View style={styles.item}>
            <View style={styles.label}>
              <Text style={styles.text}>消费时间：</Text>
            </View>
            <View style={styles.content}>
